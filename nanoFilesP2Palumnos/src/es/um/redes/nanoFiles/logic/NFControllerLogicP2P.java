...
public class NFControllerLogicP2P {
	...
	protected boolean startFileServer() {
		 ...
		 * mensaje informando sobre el puerto, y devolver verdadero. Las excepciones que
		 * puedan lanzarse deben ser capturadas y tratadas en este método. Si se produce
		 * una excepción de entrada/salida (error del que no es posible recuperarse), se
		 * debe informar sin abortar el programa
		 */
	...
	protected boolean downloadFileFromServers(InetSocketAddress[] serverAddressList, String targetFileNameSubstring,
		 ...
		 * informando de que se ha completado la descarga. Las excepciones que puedan
		 * lanzarse deben ser capturadas y tratadas en este método. Si se produce una
		 * excepción de entrada/salida (error del que no es posible recuperarse), se
		 * debe informar sin abortar el programa
		 */
	...
	protected void stopFileServer() {
		/*
		 * TODO: (FuncOpcional) Enviar señal para detener nuestro servidor de ficheros
		 * en segundo plano
		 */
