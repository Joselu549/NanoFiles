...
public class NFCommands {
  ...
  /**
   * Códigos de los comandos válidos que puede introducir el usuario del shell. El orden es
   * importante para relacionarlos con la cadena que debe introducir el usuario y con la ayuda
   */
  private static final Byte[] _valid_user_commands = {COM_QUIT, COM_PING, COM_FILELIST, COM_MYFILES,
      COM_SERVE, COM_DOWNLOAD, COM_UPLOAD, COM_HELP, COM_SOCKET_IN};

  /**
   * cadena exacta de cada orden
   */
  private static final String[] _valid_user_commands_str =
      {"quit", "ping", "filelist", "myfiles", "serve", "download", "upload", "help"};

  /**
   * Mensaje de ayuda para cada orden
   */
  private static final String[] _valid_user_commands_help =
      {"quit the application", "ping directory to check protocol compatibility",
          ...
          "download file from all available server(s)", "upload file to server",
