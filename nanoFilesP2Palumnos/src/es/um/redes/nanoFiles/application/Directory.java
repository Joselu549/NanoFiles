...
public class Directory {
  ...
  public static void main(String[] args) {
    ...
    /**
     * Command line argument to directory is optional, if not specified, default value is used:
    ...
    System.out.println(
        "Probability of corruption for received datagrams: " + datagramCorruptionProbability);
    try {
